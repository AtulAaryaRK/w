...
function game(){
  ...
  if(gameConfig.status==='gameover'){
    ...
    timeValue = speechSynthesis.cancel();
    var synth = window.speechSynthesis;
      speak_data = "All My Hearts Have been used up ! . That's The End Of My Game ! . You Have Helped Me To Collect " + round(gameConfig.scores) + "Points . Guess You Will Help Me To Score More Next Time . Thank You"
...
function changeGameStatud(character){
 if(gameConfig.status==="start" && GameStatus=="start") { 
   ...
   var synth = window.speechSynthesis;
      ...
      speak_data = "You have started your game ! . Use The Up , Down And Left Arrow keys to go ahead . "
